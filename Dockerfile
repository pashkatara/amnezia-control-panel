...
chmod 775 /var/www/html/backups /var/www/html/logs\n\
# Ensure dependencies are installed if volume is mounted from host\n\
if [ ! -f /var/www/html/vendor/autoload.php ]; then\n\
  echo "Installing composer dependencies..."\n\
  cd /var/www/html && composer install --no-dev --optimize-autoloader --no-security-blocking\n\
fi\n\
...
if [ -f /var/www/html/bin/monitor_metrics.sh ]; then\n\
